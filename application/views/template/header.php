...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/front-end/') ?>fontawesome/css/all.css">
    <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">

    <!-- Latest compiled and minified CSS -->
    <link rel="stylesheet" href="<?= base_url('assets/') ?>bootstrap-select-1.13.14/dist/css/bootstrap-select.min.css">
